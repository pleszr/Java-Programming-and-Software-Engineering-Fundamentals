...
public class MarkovOne {
    ...
    public MarkovOne(String trainingInput,int seed) {
    ...
    public ArrayList<String> getFollows(String key) {
        /*
         *  In the class MarkovOne, write the method getFollows that has one String parameter named key. This method should 
         *  find all the characters from the private variable myText in MarkovOne that follow key and put all these characters
