...
/**
This is the same exercise but resolved by @kenumali at https://github.com/kenumali/java-duke-university-coursera 
I had some issues in my code and I used his to help me find the issues in mine.
I added a main and modified it a bit to work with my functions.
It is not neccessery to run/use anything from this class to resolve the exercise.
 */
import edu.duke.*;
public class Part3 {
    ...
    public static void main (String[] args) {
        ...
        //PO.storeAllGenes(dna,geneStore);
        //PO.printAllGenes("atgXXXATGDDAD");
        StorageResource str = p3.getAllGenes(dna);
        //PO.printAllFromStorage(geneStore);
        //PO.cgRatio("abc");
        p1.processGenes(str);
    }
